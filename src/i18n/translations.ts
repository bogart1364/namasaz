    ...
    projects: {
      ...
      data: [
        ...
        },
        {
          ...
          description: 'ویلای کوهستان در دل طبیعت کردستان با رویکردی هماهنگ با محیط زیست طراحی شده است. ترکیب سنگ بومی، چوب و شیشه در نما و داخل، فضایی آرام و دلنشین ایجاد می‌کند که ارتباط مستقیم با کوهستان دارد.',
          specs: [{ label: 'مساحت', value: '۶۵۰ متر مربع' }, { label: 'موقعیت', value: 'کردستان' }, { label: 'متریال', value: 'سنگ، چوب، شیشه' }, { label: 'مدت اجرا', value: '۲۴ ماه' }, { label: 'سال تحویل', value: '۱۴۰۳' }],
          images: [
            '/assets/renders/project-12%20vila%20kohestan/00.jpg',
            '/assets/renders/project-12%20vila%20kohestan/01.jpg',
            '/assets/renders/project-12%20vila%20kohestan/02.jpg',
            '/assets/renders/project-12%20vila%20kohestan/03.jpg',
            '/assets/renders/project-12%20vila%20kohestan/04.jpg',
            '/assets/renders/project-12%20vila%20kohestan/06.jpg',
            '/assets/renders/project-12%20vila%20kohestan/07.jpg',
    ...
    projects: {
      ...
      data: [
        ...
        },
        {
          ...
          description: 'Villa Kohestan is designed in harmony with the environment of Kurdistan\'s nature. The combination of local stone, wood and glass in facade and interior creates a calm, pleasant space with a direct connection to the mountains.',
          specs: [{ label: 'Area', value: '650 sqm' }, { label: 'Location', value: 'Kurdistan' }, { label: 'Materials', value: 'Stone, Wood, Glass' }, { label: 'Duration', value: '24 months' }, { label: 'Year', value: '2024' }],
          images: [
            '/assets/renders/project-12%20vila%20kohestan/00.jpg',
            '/assets/renders/project-12%20vila%20kohestan/01.jpg',
            '/assets/renders/project-12%20vila%20kohestan/02.jpg',
