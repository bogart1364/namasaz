      ...
      data: [
        {
          ...
          images: [
            '/assets/renders/project-01%20white%20hustel/01.png',
            '/assets/renders/project-01%20white%20hustel/02.png',
            '/assets/renders/project-01%20white%20hustel/03.png',
            '/assets/renders/project-01%20white%20hustel/04.png',
          ],
        },
        {
          ...
          images: [
            '/assets/renders/sim&cable%20amol/32e788b2-0504-4510-b7b5-10339dd42510.png',
            '/assets/renders/sim&cable%20amol/c8e060af-4ea0-4c80-815e-37234b5bd7af.png',
          ],
        },
        {
          ...
          images: [
            '/assets/renders/project-03%20iran%20disel%20motor/01.png',
            '/assets/renders/project-03%20iran%20disel%20motor/02.png',
            '/assets/renders/project-03%20iran%20disel%20motor/03.png',
            '/assets/renders/project-03%20iran%20disel%20motor/04.png',
            '/assets/renders/project-03%20iran%20disel%20motor/05.png',
          ],
        },
        {
        ...
        },
        {
          ...
          images: [
            '/assets/renders/project-08%20borhan/0hero.jpg',
            '/assets/renders/project-08%20borhan/01.jpg',
            '/assets/renders/project-08%20borhan/02.jpg',
            '/assets/renders/project-08%20borhan/03.jpg',
            '/assets/renders/project-08%20borhan/04.jpg',
          ],
        },
        {
          ...
          images: [
            '/assets/renders/project-06%20vila%20%20modern%20shomal/01.png',
            '/assets/renders/project-06%20vila%20%20modern%20shomal/02.png',
            '/assets/renders/project-06%20vila%20%20modern%20shomal/03.png',
          ],
        },
        {
          id: '07', title: 'رستوران باغ صفا', subtitle: 'Restaurant Bagh Safa', category: 'تفریحی', year: '2024',
          location: 'مازندران، ایران', area: '۱,۱۰۰ متر مربع', duration: '۱۴ ماه', client: 'باغ صفا',
          ...
          images: [
            ...
            '/assets/renders/project-05%20resturant%20bagh%20safa/00.jpg',
            '/assets/renders/project-05%20resturant%20bagh%20safa/05.jpg',
            '/assets/renders/project-05%20resturant%20bagh%20safa/07.jpg',
            '/assets/renders/project-05%20resturant%20bagh%20safa/09.jpg',
          ],
        },
        {
          id: '08', title: 'بوتیک ام اند اس', subtitle: 'BOTIQ M&S', category: 'تجاری', year: '2023',
          location: 'تهران، ایران', area: '۶۵۰ متر مربع', duration: '۱۰ ماه', client: 'ام اند اس',
          description: 'بوتیک ام اند اس فضایی تجربی برای نمایش محصولات با رویکردی مینیمال و صنعتی است. ترکیب بتن اکسپوز، فولاد و نورپردازی موضعی، هویت بصری متمایزی برای برند می‌سازد و در عین حال خوانایی و جریان حرکت در فضا را حفظ می‌کند.',
          specs: [{ label: 'مساحت', value: '۶۵۰ متر مربع' }, { label: 'موقعیت', value: 'تهران' }, { label: 'متریال', value: 'بتن، فولاد، شیشه' }, { label: 'مدت اجرا', value: '۱۰ ماه' }, { label: 'سال تحویل', value: '۱۴۰۲' }],
          images: [
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_214510_HDR.jpg',
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_214611_HDR.jpg',
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_215039_HDR.jpg',
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_220812_HDR.jpg',
          ],
        },
        {
          id: '09', title: 'بوتیک میمسین', subtitle: 'Botiq Mimsin', category: 'تجاری', year: '2024',
          location: 'آمل، مازندران', area: '۵۰۰ متر مربع', duration: '۱۰ ماه', client: 'میمسین',
          description: 'طراحی داخلی و نمای بوتیک میمسین با رویکردی مینیمال و مدرن. ترکیب نورپردازی حرفه‌ای، متریال لوکس و چیدمان دقیق محصولات، فضایی تجربی و متفاوت برای مشتریان خلق می‌کند.',
          specs: [{ label: 'مساحت', value: '۵۰۰ متر مربع' }, { label: 'موقعیت', value: 'آمل' }, { label: 'متریال', value: 'چوب، فولاد، شیشه' }, { label: 'مدت اجرا', value: '۱۰ ماه' }, { label: 'سال تحویل', value: '۱۴۰۳' }],
          images: [
            '/assets/renders/project-09%20botiq%20mimsin/01.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/02.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/03.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/photo_5974171514875612696_y.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/photo_5974171514875612702_y.jpg',
          ],
        },
        {
          id: '10', title: 'دپارتمان میرو', subtitle: 'Departman Miro', category: 'تجاری', year: '2024',
          location: 'آمل، مازندران', area: '۱,۲۰۰ متر مربع', duration: '۱۴ ماه', client: 'میرو',
          description: 'طراحی دپارتمان استور میرو با فضایی باز و جریان حرکتی روان. ترکیب متریال طبیعی و نورپردازی موضعی، تجربه خریدی لذت‌بخش و حرفه‌ای را برای مشتریان فراهم می‌آورد.',
          specs: [{ label: 'مساحت', value: '۱,۲۰۰ متر مربع' }, { label: 'موقعیت', value: 'آمل' }, { label: 'متریال', value: 'سنگ، چوب، فولاد' }, { label: 'مدت اجرا', value: '۱۴ ماه' }, { label: 'سال تحویل', value: '۱۴۰۳' }],
          images: [
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612697_y.jpg',
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612698_y.jpg',
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612700_y.jpg',
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612701_y.jpg',
          ],
        },
        {
          id: '11', title: 'رستوران نصرت شاندیز', subtitle: 'Restaurant Nosrat Shandiz', category: 'تفریحی', year: '2024',
          location: 'شاندیز، خراسان', area: '۸۰۰ متر مربع', duration: '۱۲ ماه', client: 'نصرت شاندیز',
          description: 'رستوران نصرت شاندیز با الهام از معماری سنتی خراسان و ترکیب آن با عناصر مدرن طراحی شده است. فضای داخلی با استفاده از سنگ، آجر و چوب، حس گرم و صمیمی را به مهمانان منتقل می‌کند.',
          specs: [{ label: 'مساحت', value: '۸۰۰ متر مربع' }, { label: 'موقعیت', value: 'شاندیز' }, { label: 'متریال', value: 'سنگ، آجر، چوب' }, { label: 'مدت اجرا', value: '۱۲ ماه' }, { label: 'سال تحویل', value: '۱۴۰۳' }],
          images: [
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/00.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/01.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/02.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/03.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/04.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/05.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/IMG_1733.JPG',
          ],
        },
        {
          id: '12', title: 'ویلای کوهستان', subtitle: 'Villa Kohestan', category: 'مسکونی', year: '2024',
          location: 'کردستان، ایران', area: '۶۵۰ متر مربع', duration: '۲۴ ماه', client: 'شخصی',
          description: 'بازسازی ویلای قدیمی در دل طبیعت کردستان با رویکردی هماهنگ با محیط زیست منطقه. تمرکز اصلی پروژه بر بازطراحی پوسته نما، اضافه کردن فضاهای جدید و بهره‌گیری از معماری پارامتریک در طراحی سقف‌های چوبی بوده است. متریال‌های سنگ بازالت، چوب ترمووود، آجر قزاق و کامپوزیت در ترکیبی مدرن و بومی به کار رفته‌اند. ویلا دارای جکوزی و استخر سرپوشیده با سقف برقی جمع‌شونده و سیستم اتوماسیون هوشمند کامل است.',
          specs: [{ label: 'مساحت', value: '۶۵۰ متر مربع' }, { label: 'موقعیت', value: 'کردستان' }, { label: 'متریال', value: 'سنگ بازالت، ترمووود، آجر قزاق، کامپوزیت' }, { label: 'مدت اجرا', value: '۲۴ ماه' }, { label: 'سال تحویل', value: '۱۴۰۳' }, { label: 'ویژگی', value: 'استخر سقف جمع‌شونده، اتوماسیون هوشمند' }],
          images: [
            '/assets/renders/project-12%20vila%20kohestan/111.jpg',
            '/assets/renders/project-12%20vila%20kohestan/222.jpg',
            '/assets/renders/project-12%20vila%20kohestan/333.jpg',
            '/assets/renders/project-12%20vila%20kohestan/444.jpg',
            '/assets/renders/project-12%20vila%20kohestan/555.jpg',
            '/assets/renders/project-12%20vila%20kohestan/666.jpg',
            '/assets/renders/project-12%20vila%20kohestan/777.jpg',
            '/assets/renders/project-12%20vila%20kohestan/888.jpg',
          ],
        },
      ],
    },
    products: {
      ...
      data: [
        ...
        },
        {
          ...
          story: 'چوب گردو که سال‌ها در خواب شب بوده، حالا بستری آرام برای استراحت شده. سطح صاف و گرم آن حس زمین را منتقل می‌کند و پایه‌های آهنی سیاه استحکام را به ارمغان می‌آورند.',
          storyEn: 'Walnut wood that slept for years now becomes a calm bed for rest. Its smooth, warm surface conveys the feeling of earth, while black iron legs bring strength.',
        ...
        {
          id: 'P10', name: 'میز وسط', nameEn: 'Coffee Table', category: 'میز', categoryEn: 'Table',
        ...
        },
        {
          ...
          origin: 'جنگل‌های شمال ایران', originEn: 'Northern Iran Forests',
          story: 'سطح گرد گردو که از یک تنه کهنسال تراش خورده، دورهمی‌های صمیمی را گرد هم می‌آورد. پایه‌های فولادی سیاه استحکام را با ظرافت ترکیب می‌کنند.',
          storyEn: 'A round walnut top turned from an aged trunk gathers intimate gatherings. Black steel legs combine strength with delicacy.',
          dimension: '۱۰۰ × ۱۰۰ × ۷۵ سانتی‌متر', dimensionEn: '100 × 100 × 75 cm',
          color: 'کرم + مشکی مات', colorEn: 'Cream + Matte Black',
        ...
        {
          id: 'P16', name: 'میز گردو', nameEn: 'Walnut Round Table', category: 'میز', categoryEn: 'Table',
          material: 'چوب گردو + فولاد سیاه', materialEn: 'Walnut Wood + Black Steel',
          origin: 'باغ‌های گردوی همدان', originEn: 'Walnut Gardens of Hamadan',
          story: 'سطح گرد گردو که از یک تنه کهنسال تراش خورده، دورهمی‌های صمیمی را گرد هم می‌آورد. پایه‌های فولادی سیاه استحکام را با ظرافت ترکیب می‌کنند.',
          storyEn: 'A round walnut top turned from an aged trunk gathers intimate gatherings. Black steel legs combine strength with delicacy.',
          ...
          style: 'مینیمال رستیک', styleEn: 'Minimal Rustic',
          price: 'تماس بگیرید', priceEn: 'Contact',
          image: '/assets/gallery-products/np16-walnut-table/10.jpg',
          images: ['/assets/gallery-products/np16-walnut-table/10.jpg','/assets/gallery-products/np16-walnut-table/11.jpg','/assets/gallery-products/np16-walnut-table/12.jpg'],
        },
        {
          id: 'P17', name: 'مبل تک نفره', nameEn: 'Single Sofa', category: 'مبلمان', categoryEn: 'Furniture',
          material: 'چوب راش + پارچه مخمل', materialEn: 'Beech Wood + Velvet Fabric',
          origin: 'کارگاه نماساز، آمل', originEn: 'NAMASAZ Workshop, Amol',
          story: 'صندلی تک‌نفره‌ای با قاب چوبی راش و نشیمن مخمل که برای فضاهای مطالعه و استراحت طراحی شده. راحتی بی‌آلایش در کمترین جا.',
          storyEn: 'A single seat with a beech frame and velvet cushion, designed for reading nooks and rest. Unassuming comfort in minimal space.',
          dimension: '۷۰ × ۸۰ × ۹۰ سانتی‌متر', dimensionEn: '70 × 80 × 90 cm',
          color: 'خاکستری + چوبی', colorEn: 'Gray + Wood',
          finish: 'روغن چوب + دوخت دستی', finishEn: 'Wood Oil + Hand Stitch',
          weight: '۲۲ کیلوگرم', weightEn: '22 kg',
          style: 'مینیمال رستیک', styleEn: 'Minimal Rustic',
          price: 'تماس بگیرید', priceEn: 'Contact',
          image: '/assets/gallery-products/np17-single-sofa/00.jpg',
          images: ['/assets/gallery-products/np17-single-sofa/00.jpg','/assets/gallery-products/np17-single-sofa/01.jpg','/assets/gallery-products/np17-single-sofa/03.jpg','/assets/gallery-products/np17-single-sofa/04.jpg'],
        },
        {
          id: 'P18', name: 'نیمکت', nameEn: 'Bench', category: 'نیمکت', categoryEn: 'Bench',
          material: 'چوب بلوط + فولاد سیاه', materialEn: 'Oak Wood + Black Steel',
          origin: 'جنگل‌های ارسباران، آذربایجان', originEn: 'Arasbaran Forests, Azerbaijan',
          story: 'نیمکتی از چوب درختان جوان که تازه راه افتاده‌اند. نماد شروع و امید، با پایه‌های فولادی که استحکام آینده را نوید می‌دهند. مناسب فضاهای انتظار و ورودی‌ها.',
          storyEn: 'A bench from young trees just beginning their journey. A symbol of new beginnings and hope, with steel legs promising future strength. Ideal for waiting areas and entrances.',
          dimension: '۱۲۰ × ۴۰ × ۴۵ سانتی‌متر', dimensionEn: '120 × 40 × 45 cm',
          ...
          style: 'مینیمال رستیک', styleEn: 'Minimal Rustic',
          price: 'تماس بگیرید', priceEn: 'Contact',
          image: '/assets/gallery-products/np18-bench/13.jpg',
          images: ['/assets/gallery-products/np18-bench/13.jpg','/assets/gallery-products/np18-bench/14.jpg','/assets/gallery-products/np18-bench/photo_5974171514875612568_y.jpg'],
        },
        {
          id: 'P19', name: 'اویز لباس', nameEn: 'Coat Rack', category: 'جاکلباس', categoryEn: 'Coat Rack',
          material: 'چوب بلوط + آهن کوبیده', materialEn: 'Oak Wood + Hand-Forged Iron',
          origin: 'کوه‌های زاگرس، لرستان', originEn: 'Zagros Mountains, Lorestan',
          story: 'تکه‌ای از بلوط کوهی که در طوفان شکسته بود، حالا نشیمنی شده برای کسی که می‌خواهد زمین را حس کند. پایه‌های آهن کوبیده با دست ساخته شده‌اند و هر ضربه پتک روی آنها یادآور تلاش انسان برای رام کردن طبیعت است.',
          storyEn: 'A piece of mountain oak broken in a storm, now a seat for someone who wants to feel the earth. Hand-forged iron legs bear the mark of every hammer blow — a reminder of humanity\'s effort to tame nature.',
          ...
          style: 'مینیمال رستیک', styleEn: 'Minimal Rustic',
          price: 'تماس بگیرید', priceEn: 'Contact',
          image: '/assets/gallery-products/np19-coat-rack/15.jpg',
          images: ['/assets/gallery-products/np19-coat-rack/15.jpg','/assets/gallery-products/np19-coat-rack/16.jpg','/assets/gallery-products/np19-coat-rack/17.jpg'],
        },
        {
          id: 'P20', name: 'مبل ۳ نفره', nameEn: '3-Seater Sofa', category: 'مبلمان', categoryEn: 'Furniture',
          material: 'چوب راش + پارچه مخمل', materialEn: 'Beech Wood + Velvet Fabric',
          origin: 'کارگاه نماساز، آمل', originEn: 'NAMASAZ Workshop, Amol',
          story: 'مبل سه‌نفره با قاب چوبی راش و نشیمن مخمل که فضای نشیمن را صمیمی و دعوت‌کننده می‌کند. ترکیب متریال بومی و راحتی مدرن.',
          storyEn: 'A three-seater sofa with a beech frame and velvet cushion that makes the living space intimate and inviting. Local material blended with modern comfort.',
          dimension: '۲۰۰ × ۸۵ × ۹۰ سانتی‌متر', dimensionEn: '200 × 85 × 90 cm',
          color: 'خاکستری + چوبی', colorEn: 'Gray + Wood',
          finish: 'روغن چوب + دوخت دستی', finishEn: 'Wood Oil + Hand Stitch',
          weight: '۴۵ کیلوگرم', weightEn: '45 kg',
          style: 'مینیمال رستیک', styleEn: 'Minimal Rustic',
          price: 'تماس بگیرید', priceEn: 'Contact',
          image: '/assets/gallery-products/np20-3seat-sofa/05.jpg',
          images: ['/assets/gallery-products/np20-3seat-sofa/05.jpg','/assets/gallery-products/np20-3seat-sofa/06.jpg','/assets/gallery-products/np20-3seat-sofa/07.jpg','/assets/gallery-products/np20-3seat-sofa/08.jpg','/assets/gallery-products/np20-3seat-sofa/09.jpg'],
        },
      ],
    },
    about: {
  ...
  en: {
    ...
    projects: {
      ...
      data: [
        ...
        {
          id: '07', title: 'Restaurant Bagh Safa', subtitle: 'رستوران باغ صفا', category: 'Hospitality', year: '2024',
          location: 'Mazandaran, Iran', area: '1,100 sqm', duration: '14 months', client: 'Bagh Safa',
        ...
        {
          id: '08', title: 'BOTIQ M&S', subtitle: 'بوتیک ام اند اس', category: 'Commercial', year: '2023',
          location: 'Tehran, Iran', area: '650 sqm', duration: '10 months', client: 'M&S',
          description: 'BOTIQ M&S is an experiential space for product display with a minimal, industrial approach. The combination of exposed concrete, steel and accent lighting builds a distinct visual identity for the brand while preserving legibility and flow.',
          specs: [{ label: 'Area', value: '650 sqm' }, { label: 'Location', value: 'Tehran' }, { label: 'Materials', value: 'Concrete, Steel, Glass' }, { label: 'Duration', value: '10 months' }, { label: 'Year', value: '2023' }],
          images: [
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_214510_HDR.jpg',
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_214611_HDR.jpg',
            '/assets/renders/project-07%20botiq%20m&s/IMG_20190612_215039_HDR.jpg',
        ...
        {
          id: '09', title: 'Botiq Mimsin', subtitle: 'بوتیک میمسین', category: 'Commercial', year: '2024',
          location: 'Amol, Mazandaran', area: '500 sqm', duration: '10 months', client: 'Mimsin',
          description: 'Interior and facade design of Botiq Mimsin boutique with a minimal, modern approach. The combination of professional lighting, luxury materials and precise product arrangement creates an experiential, unique space for customers.',
          specs: [{ label: 'Area', value: '500 sqm' }, { label: 'Location', value: 'Amol' }, { label: 'Materials', value: 'Wood, Steel, Glass' }, { label: 'Duration', value: '10 months' }, { label: 'Year', value: '2024' }],
          images: [
            '/assets/renders/project-09%20botiq%20mimsin/01.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/02.jpg',
            '/assets/renders/project-09%20botiq%20mimsin/03.jpg',
        ...
        {
          id: '10', title: 'Departman Miro', subtitle: 'دپارتمان میرو', category: 'Commercial', year: '2024',
          location: 'Amol, Mazandaran', area: '1,200 sqm', duration: '14 months', client: 'Miro',
          description: 'Design of Miro department store with an open space and smooth movement flow. The combination of natural materials and accent lighting provides an enjoyable, professional shopping experience for customers.',
          specs: [{ label: 'Area', value: '1,200 sqm' }, { label: 'Location', value: 'Amol' }, { label: 'Materials', value: 'Stone, Wood, Steel' }, { label: 'Duration', value: '14 months' }, { label: 'Year', value: '2024' }],
          images: [
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612697_y.jpg',
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612698_y.jpg',
            '/assets/renders/project-10%20departman%20miro/photo_5974171514875612700_y.jpg',
        ...
        {
          id: '11', title: 'Restaurant Nosrat Shandiz', subtitle: 'رستوران نصرت شاندیز', category: 'Hospitality', year: '2024',
          location: 'Shandiz, Khorasan', area: '800 sqm', duration: '12 months', client: 'Nosrat Shandiz',
          description: 'Restaurant Nosrat Shandiz is designed inspired by traditional Khorasani architecture combined with modern elements. The interior, using stone, brick and wood, conveys a warm, intimate feeling to guests.',
          specs: [{ label: 'Area', value: '800 sqm' }, { label: 'Location', value: 'Shandiz' }, { label: 'Materials', value: 'Stone, Brick, Wood' }, { label: 'Duration', value: '12 months' }, { label: 'Year', value: '2024' }],
          images: [
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/00.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/01.JPG',
            '/assets/renders/project-11%20resturan%20nosrat%20shandiz/02.JPG',
        ...
        {
          id: '12', title: 'Villa Kohestan', subtitle: 'ویلای کوهستان', category: 'Residential', year: '2024',
          location: 'Kurdistan, Iran', area: '650 sqm', duration: '24 months', client: 'Private',
          description: 'Renovation of an old villa in the heart of Kurdistan\'s nature, harmonizing with the local environment. The project focused on redesigning the facade skin, adding new spaces and utilizing parametric architecture in the design of wooden ceilings. Materials include basalt stone, thermowood, Qazak brick and composite in a modern, local composition. The villa features a jacuzzi and indoor pool with a retractable electric roof and a full smart home automation system.',
          specs: [{ label: 'Area', value: '650 sqm' }, { label: 'Location', value: 'Kurdistan' }, { label: 'Materials', value: 'Basalt, Thermowood, Qazak Brick, Composite' }, { label: 'Duration', value: '24 months' }, { label: 'Year', value: '2024' }, { label: 'Features', value: 'Retractable Pool Roof, Smart Automation' }],
          images: [
            '/assets/renders/project-12%20vila%20kohestan/111.jpg',
            '/assets/renders/project-12%20vila%20kohestan/222.jpg',
            '/assets/renders/project-12%20vila%20kohestan/333.jpg',
